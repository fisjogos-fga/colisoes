...
COMPETÊNCIAS:
    ...
    [fis-momento]:
        Aplicar a lei de conservação de momentum linear em problemas de física
        e realizar cálculos de momento linear total de sistemas de partícula.

    [fis-restituição]: 
        Compreender o conceito de coeficiente de restituição e saber aplicá-lo
        em problemas simples de colisões.
